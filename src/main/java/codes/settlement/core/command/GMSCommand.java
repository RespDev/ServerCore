...
public final class GMSCommand extends AbstractCommand {
    public GMSCommand() {
        super("gms", "Changes the players gamemode to Survival", Permission.GAMEMODE_COMMAND, "survival");
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        player.sendMessage(Utils.color("&aYour gamemode has been set to: &bSURVIVAL&a."));
    }
